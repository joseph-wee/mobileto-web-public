    ...
    <div className="relative pb-[264px] md720:pb-[173px] tall:pb-0">
      ...
      <div className="mx-auto pl-[18px] pr-[18px] pt-[113px] pb-[40px] max-w-[1030px] box-content">
        ...
        <p className="text-[18px] font-light">
          ...
          <br /> We may also collect non-personal information about your use of
          the App, such as:
          <br />
          ...
          <br />
          <br />
          <strong className="font-bold">3. How We Use Your Information</strong>
          <br />
          <br />
          ...
          <br /> To develop new products, services, features, and functionality
